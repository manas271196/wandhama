...
var families = [["Asset 1.png", "Predman Bhat", 45], ["Asset 2.png", "Rakesh Bhat", 23], ["Asset 3.png", "Amit Bhat", 19], ["Asset 6.png", "Princy Bhat", 29], ["Asset 9.png", "Rajani Bhat", 43], ["Asset 12.png", "Girja Bhat", 41], ["Asset 11.png", "Preetma Bhat", 22], ["Asset 13.png", "Sh Laas Koul", 42], ["Asset 5.png", "Sh. Radha Krishen", 13], ["Asset 4.png", "Sh. Bansi Lal", 35], ["Asset 7.png", "Sh. Bandi Lal ", 26], ["Asset 14.png", "Sh. Mohan Lal", 40], ["Asset 8.png", "Sh. Triloki Nath", 27], ["Asset 10.png", "Amit Bhat", 19], ["Asset 15.png", "Smt. Geeta ", 40], ["Asset 16.png", "Smt. Chand Rani", 28], ["Asset 17.png", "Sh. Lok Nath ", 42], ["Asset 18.png", "Sh. Avatar Kishan", 27], ["Asset 19.png", "Sushma Bhat", 13]];
var x = 0;
var perRow = 5;
var desc = d3.select(".pic-description"); // while (x < pics.length) {

for (var i = 0; i < families.length; i++) {
  var photos = d3.select(".photos > .photo-row");
  var cont = photos.append("div").attr("class", "photo-container").attr("data-name", families[i][1]).attr("data-age", families[i][2]);
...
d3.selectAll(".photo-container").on("mouseover", function (e) {
  ...
  desc.select(".age").text(pic.dataset.age); // desc.classed("show", true);
...
},{}]},{},["../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","wandhama.js"], null)
//# sourceMappingURL=/wandhama.7b1dc418.js.map